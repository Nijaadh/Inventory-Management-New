...
public class AdminVerify extends javax.swing.JFrame {
    ...
    private AdminVerify(String userName) {
    ...
    private void initComponents() {
        ...
        lblFogotPassword.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        lblFogotPassword.setForeground(new java.awt.Color(255, 255, 255));
        lblFogotPassword.setText("Fogot Password?");
        lblFogotPassword.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                lblFogotPasswordMouseClicked(evt);
            }
        });
        ...
        jLabel8.setText("Admin Verification");
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(lblFogotPassword, javax.swing.GroupLayout.PREFERRED_SIZE, 121, javax.swing.GroupLayout.PREFERRED_SIZE))))
    ...
    private void brnSignInMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_brnSignInMouseClicked
        try {
            ...
            String sql = "SELECT * FROM user WHERE uUserName = '"+userName+"' && uPassword = '"+password+"' && userType='"+type+"'";
...
//                JOptionPane.showMessageDialog(null,"Login is Sucessfull...");
                ...
                JOptionPane.showMessageDialog(null,"Admin name or password incorrect..");
            }
        } catch (Exception e) {
        }
    ...
    private void lblFogotPasswordMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblFogotPasswordMouseClicked
         this.dispose();
                DashBoardForm DBForm = new DashBoardForm(userName);
                DBForm.setVisible(true);
                JOptionPane.showMessageDialog(null,"Login is Sucessfull...");
    }//GEN-LAST:event_lblFogotPasswordMouseClicked
